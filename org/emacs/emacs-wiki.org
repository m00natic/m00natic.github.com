...
the changes just in some selection.  [[http://www.gnu.org/software/emacs/manual/html_node/emacs/Using-Region.html][Here]] (and in the manual) is an
...
by default. The first one integrates nicely with [[Elisp]]:
