...
(*M* stands for *<Alt>*, so invoke *<Alt>+<x>*, release these keys,
type *tetris* and press *<Enter>* ...by the way this is a real
command, try it!)

*C-x C-f PATH-TO-SOME-FILE*

(*C* stands for *<Ctrl>*, so invoke *<Ctrl>+<x>*, release these keys,
invoke *<Ctrl>+<f>*, release these keys, type path to some file or
directory and then press *<Enter>*)

*C-x v d PATH-TO-VERSION-CONTROLLED-FOLDER*

(invoke *<Ctrl>+<x>*, relese these keys, press *<v>*, release, press
...
in a middle of [[Search%20for%20great%20good][incremental search]] or whatever.  Suddenly you come to
...
forward or *C-r* to do it backward.  This is traditional way of just
moving around text too.  More precise and reliable than even a mouse!
...
- [[Undo/redo][undo]] acts only on the region
...
*C-x C-f /ssh:andrey@some-server:/path/to/some/file/or/folder RET*
...
*<S>* to save them all.  Job done.  As all within La la land, IBuffer
...
and press *<Tab>*, it will expand as much as necessary.  You can
create tables from blocks of text that look like one (like coma or
whitespace separated rows of values) with
...
(Elisp).  All magic interactivity is a byproduct of this.  All
parenthesized settings and code snippets from above are actually Elisp
program pieces.  I won't go into details how [[http://www.youtube.com/watch?v%3DHM1Zb3xmvMc][cool]] Lisp-like languages
are, [[http://www.paulgraham.com/diff.html][there]] [[http://www.paulgraham.com/avg.html][is]] a [[http://www.gigamonkeys.com/book/introduction-why-lisp.html][lot]] of [[http://www.gigamonkeys.com/book/macros-defining-your-own.html][material]] out [[http://www.defmacro.org/ramblings/lisp.html][there]].  I won't tell you much
about Elisp either for the built-in manual is outstanding:
...
are not set in stones, make them powerful for your tasks.  Unlike most
other tools, learning Emacs[fn:3] can pay off spectacularly,
especially in terms of productivity.  As with most other quality
things in life, if you persist, it will deliver.
...
[fn:2] Some people write even [[http://elnode.org/][web servers]] nowadays

[fn:3] Realistically, no mortal can learn Emacs in its entirety
