...
mail accounts?  [[Don't%20ask%20for%20sudo%20or%20ssh%20passwords][authinfo]](.gpg) to the rescue again!
...
This one is an almost 1:1 wrapper for systems that provide Unix like
terminals:
...
program pieces.  Here's a nice built-in introduction:
