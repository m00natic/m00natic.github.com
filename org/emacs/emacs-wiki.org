...
Like other [[http://www.gnu.org/][GNU tools]], *grep* has nice integration within Emacs.  I
most frequently need recursive searching within some directory and its
...
And you'll be able to select a file.  If you have [[Fuzzy%20matching%20when%20navigating%20the%20file%20system][ido-mode]] enabled for
...
tools, learning Emacs[fn:3] can pay off spectacularly, especially in
...
[fn:2] Some people even write [[http://elnode.org/][web servers]] nowadays
