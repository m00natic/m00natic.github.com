...
If search was successful (ending with *<Enter>*), [[Markers][mark]] has been
...
selection should end.  [[Search%20for%20great%20good][Incremental search]] is allowed!  Not only this,
...
by default. The first one integrates nicely with [[Emacs%20Lisp][Elisp]]:
