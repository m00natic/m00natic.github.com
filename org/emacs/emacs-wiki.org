...
~C-x C-f /ssh:andrey@some-server:/ezsroot/current RET~
...
explained [[Remote%20network%20and%20sudo%20access][above]], you'll be asked for the ~.authinfo.gpg~ password once
...
practical consequences.  While Elisp is quite an adequate lisp, it
really shines in...
