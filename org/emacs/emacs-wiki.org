...
managers]] and [[http://www.emacswiki.org/emacs/MusicPlayers][players]], [[http://www.emacswiki.org/emacs/CategoryGames][games]], [[http://emacswiki.org/emacs/EmacsDoctor][psychotherapist]],
[[http://youtu.be/D1sXuHnf_lo][controlling vibrators]]... to name a
few.  Oops, overdid it somewhere.
...
undos, which is roughly equivalent to redo.  (If you made it through
the last sentence, require your award.)  This is a very powerful
mechanism but a brain-twister for novices.  Try out [[http://www.emacswiki.org/emacs/UndoTree][Undo
...
selectively choose which ones to stage or unstage (works not just for
hunks but for arbitrary marked region!).  Makes partial file commits
trivial.
...
resources I have ever seen (only second to [[http://en.wikipedia.org/wiki/Lisp_machine][Lisp Machines]]'s [[http://en.wikipedia.org/wiki/Genera_%2528operating_system%2529][Genera
operating systems]] but they are 20 years in the past and as one may
observe, technology is stubbornly regressing in this along other
aspects since then).
...
This guide is all done in Org mode and then exported to HTML (one of
...
3. (Optional) Jump to the definitions of the above commands and have a
   look at their code.  Not only will you see how adequate Elisp looks
   like, but you may also detect some more primitive function used
   that may fit your bill.
